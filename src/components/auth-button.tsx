      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          {session.user.image ? (
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100/80 dark:bg-emerald-900/80 backdrop-blur-[3px]">
        ...
        <button
          onClick={() => signOut()}
          className="flex items-center gap-2 rounded-full border border-white/40 dark:border-gray-700/40 bg-white/60 dark:bg-gray-900/60 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 shadow-md backdrop-blur-[3px] transition-all hover:bg-white/80 dark:hover:bg-gray-800/80 hover:shadow-lg"
        >
